              ...
              {toc.map((content: any) => {
                return (
                  <Link
                    ...
                    className="relative overflow-hidden hover:bg-[color:var(--color-text-alt)] px-2 py-0.5 md:py-1 rounded-tr-md rounded-br-md md:line-clamp-1 text-neutral-700 hover:text-white  dark:text-neutral-200 font-medium border-l-2 border-neutral-500 dark:hover:border-white"
