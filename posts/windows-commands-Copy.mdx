  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        used by the Address in Networks and communication management
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Enables you to quickly set up a system partition, or to repair the boot
    ...
    <tr>
      ...
      <td>
        ...
        choices in a batch program, and then returns the index of the selected
        choice. If used without parameters,&nbsp;choice&nbsp;displays the
        default choices&nbsp;Y&nbsp;and&nbsp;N.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        [covert](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/convert)
      </td>
    ...
    <tr>
      ...
      <td>
        Locates and consolidates fragmented files on local volumes to improve
        system performance.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        helps you manage your computer's drives (disks, partitions, volumes, or
        virtual hard disks)
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        Recalls previously entered command-line commands, edits command lines,
        and creates macros.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        Enables an administrator to create a custom event in a specified event
        log
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        [extrac32](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/extract)
      </td>
    ...
    <tr>
      ...
      <td>
        Enables Windows optional features by downloading required files from
        Windows Update or another source specified by Group Policy
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Selects and runs a command on a file or set of files. This command is
    ...
    <tr>
      ...
      <td>
        Format a disk to accept Windows files. You must be a member of the
        Administrators group to format a hard drive
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Allows you to register or save performance counter name and registry
        settings in a file and designate trusted services
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Creates, deletes, or lists a volume mount point. You can also link
    ...
    <tr>
      ...
      <td>
        Invokes a troubleshooting pack at the command line or as part of an
        automated script, and enables additional options without user input
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Installs the Windows Preinstallation Environment (WinPE), a lightweight
    ...
    <tr>
      <td>
        [net
        print](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/net-print)
      </td>
      <td>
        Displays information about a specified printer queue or a specified
    ...
    <tr>
      <td>
        [net](https://docs.microsoft.com/en-us/troubleshoot/windows-server/networking/net-commands-on-operating-systems)
      </td>
    ...
    <tr>
      ...
      <td>
        Used for advanced packet capture and event collection, drop detection,
    ...
    <tr>
      ...
      <td>
        Audits a computer for device drivers, and performs unattended driver
        installations, or searches for drivers without installing and,
        optionally, report the results to the command line
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        [powerShell\_ise](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/powershell_ise)
      </td>
      <td>
        Windows PowerShell Integrated Scripting Environment (ISE) is a graphical
        host application that enables you to read, write, run, debug, and test
        scripts
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        Displaying any text you want, such as the name of the current directory,
    ...
    <tr>
      ...
      <td>
        ReFSUtil is a tool included in Windows and Windows Server that attempts
        to diagnose heavily damaged ReFS volumes
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Performs operations on registry subkey information and values in
        registry entries
      </td>
    </tr>
    <tr>
      ...
      <td>
        Modifies the registry from the command line or a script, and applies
        changes that were present in one or more text files
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Extracts performance counters from performance counter logs into other
        formats, such as text-TSV (for tab-delimited text), text-CSV (for
    ...
    <tr>
      ...
      <td>
        Records comments in a script, batch, or config.sys file. If no comment
        is specified, rem adds vertical spacing
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Replace existing files in a directory. If used with the \`/a\` option,
        this command adds new files to a directory instead of replacing existing
        files
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        [route](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/route_ws2008)
      </td>
    ...
    <tr>
      ...
      <td>
        Confirms the RPC connectivity between the computer running Microsoft
    ...
    <tr>
      <td>
        [rasdial](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/ff859533(v=ws.11))
      </td>
    ...
    <tr>
      <td>
        [sc](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/cc754599(v=ws.11))
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        environment, without requiring programming or scripting
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Scans and verifies the integrity of all protected system files and
        replaces incorrect versions with correct versions
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        This utility can be used to get information about the Trusted Platform
        Module (TPM).
      </td>
    </tr>
    <tr>
      ...
      <td>
        The tpmvscmgr command-line tool allows users with Administrative
        credentials to create and delete TPM virtual smart cards on a computer
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        The tracerpt command parses Event Trace Logs, log files generated by
        Performance Monitor, and real-time Event Trace providers
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Removes Performance counter names and Explains text for a service or
        device driver from the system registry
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Driver Verifier monitors Windows kernel-mode drivers and graphics
    ...
    <tr>
      ...
      <td>
        Enables you to back up and restore your operating system, volumes,
        files, folders, and applications from a command prompt
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Enables you to create and manage subscriptions to events that are
    ...
    <tr>
      ...
      <td>
        Displays user, group, and privileges information for the user who is
    ...
    <tr>
      ...
      <td>
        Windows Remote Management allows you to manage and execute programs
        remotely
      </td>
    </tr>
    <tr>
      <td>
        [winrm](https://docs.microsoft.com/en-us/windows/win32/winrm/installation-and-configuration-for-windows-remote-management#where-winrm-is-installed)
      </td>
    ...
    <tr>
      ...
      <td>
        Windows Script Host provides an environment in which users can execute
        scripts in a variety of languages that use a variety of object models to
        perform tasks
      </td>
    </tr>
    <tr>
...
There are many more commands that I might have missed those commands will be added later. You can extend your support by [Buying me a Coffee](https://buymeacoffee.com/valentina)
